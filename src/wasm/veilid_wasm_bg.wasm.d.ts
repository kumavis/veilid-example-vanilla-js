...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2bed0e72eaed05da(a: number, b: number, c: number): void;
